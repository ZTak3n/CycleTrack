...
class Got10k_flow(BaseVideoDataset):
    """ GOT-10k dataset.
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None, min_score = 0.5):
        ...
        super().__init__('GOT10k_flow', root, image_loader)
        ...
        print('Got10k : Optical flow score: %s, keep ratio: %f'%(self.threshold, L2/L1))
    ...
    def _get_valid_seq(self):
        max_file =  os.path.join(self.flow_root,'got10k_max.txt')
    ...
    def _read_flow_anno(self, seq_id):
        ...
        det_file = os.path.join(self.flow_root,'got10k', seq_name+'.txt')
        try:
