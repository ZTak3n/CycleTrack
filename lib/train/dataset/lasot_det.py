...
class lasot_det(BaseVideoDataset):
    """ LaSOT dataset.
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None, min_score = 0.5):
        ...
        super().__init__('lasot_det', root, image_loader)
        ...
        print('LaSOT : Detection score: %s, keep ratio: %f'%(self.threshold, L2/L1))
    ...
    def _get_valid_seq(self):
        max_file =  os.path.join(self.det_root,'lasot_max.txt')
    ...
    def _read_det_anno(self, seq_id):
        ...
        det_file = os.path.join(self.det_root,'lasot', seq_name+'.txt')
        try:
